...
const SLuaCommands simLuaCommands[]=
{
    ...
    {"sim.importMesh",_simImportMesh,                            "table_of_table vertices,table_of_table indices,nil,table names=sim.importMesh(number fileformat,string pathAndFilename,\nnumber options,number identicalVerticeTolerance,number scalingFactor)",true},
    {"sim.exportMesh",_simExportMesh,                            "number result=sim.exportMesh(number fileformat,string pathAndFilename,number options,number scalingFactor,\ntable_of_table vertices,table_of_table indices,nil,table names)",true},
    ...
    {"sim.openTextEditor",_simOpenTextEditor,                    "string text,table_2 size,table_2 position=sim.openTextEditor(string initText,string xml=nil)",true},
...
{ // Following for backward compatibility (has now a new notation (see 'simLuaCommands'))
    {"simGetScriptName",_simGetScriptName,                      "Please use the newer 'sim.getScriptName' notation",false},
    {"simGetObjectAssociatedWithScript",_simGetObjectAssociatedWithScript,"Please use the newer 'sim.getObjectAssociatedWithScript' notation",false},
    {"simGetScriptAssociatedWithObject",_simGetScriptAssociatedWithObject,"Please use the newer 'sim.getScriptAssociatedWithObject' notation",false},
    {"simGetCustomizationScriptAssociatedWithObject",_simGetCustomizationScriptAssociatedWithObject,"Please use the newer 'sim.getCustomizationScriptAssociatedWithObject' notation",false},
    {"simGetScriptExecutionCount",_simGetScriptExecutionCount,  "Please use the newer 'sim.getScriptExecutionCount' notation",false},
    {"simIsScriptExecutionThreaded",_simIsScriptExecutionThreaded,"Please use the newer 'sim.isScriptExecutionThreaded' notation",false},
    {"simIsScriptRunningInThread",_simIsScriptRunningInThread,  "Please use the newer 'sim.isScriptRunningInThread' notation",false},
    {"simOpenModule",_simOpenModule,                            "Please use the newer 'sim.openModule' notation",false},
    {"simCloseModule",_simCloseModule,                          "Please use the newer 'sim.closeModule' notation",false},
    {"simHandleModule",_simHandleModule,                        "Please use the newer 'sim.handleModule' notation",false},
    {"simBoolOr32",_simBoolOr32,                                "Please use the newer 'sim.boolOr32' notation",false},
    {"simBoolAnd32",_simBoolAnd32,                              "Please use the newer 'sim.boolAnd32' notation",false},
    {"simBoolXor32",_simBoolXor32,                              "Please use the newer 'sim.boolXor32' notation",false},
    {"simHandleDynamics",_simHandleDynamics,                    "Please use the newer 'sim.handleDynamics' notation",false},
    {"simHandleIkGroup",_simHandleIkGroup,                      "Please use the newer 'sim.handleIkGroup' notation",false},
    {"simCheckIkGroup",_simCheckIkGroup,                        "Please use the newer 'sim.checkIkGroup' notation",false},
    {"simHandleCollision",_simHandleCollision,                  "Please use the newer 'sim.handleCollision' notation",false},
    {"simReadCollision",_simReadCollision,                      "Please use the newer 'sim.readCollision' notation",false},
    {"simHandleDistance",_simHandleDistance,                    "Please use the newer 'sim.handleDistance' notation",false},
    {"simReadDistance",_simReadDistance,                        "Please use the newer 'sim.readDistance' notation",false},
    {"simHandleProximitySensor",_simHandleProximitySensor,      "Please use the newer 'sim.handleProximitySensor' notation",false},
    {"simReadProximitySensor",_simReadProximitySensor,          "Please use the newer 'sim.readProximitySensor' notation",false},
    {"simHandleMill",_simHandleMill,                            "Please use the newer 'sim.handleMill' notation",false},
    {"simResetCollision",_simResetCollision,                    "Please use the newer 'sim.resetCollision' notation",false},
    {"simResetDistance",_simResetDistance,                      "Please use the newer 'sim.resetDistance' notation",false},
    {"simResetProximitySensor",_simResetProximitySensor,        "Please use the newer 'sim.resetProximitySensor' notation",false},
    {"simResetMill",_simResetMill,                              "Please use the newer 'sim.resetMill' notation",false},
    {"simCheckProximitySensor",_simCheckProximitySensor,        "Please use the newer 'sim.checkProximitySensor' notation",false},
    {"simCheckProximitySensorEx",_simCheckProximitySensorEx,    "Please use the newer 'sim.checkProximitySensorEx' notation",false},
    {"simCheckProximitySensorEx2",_simCheckProximitySensorEx2,  "Please use the newer 'sim.checkProximitySensorEx2' notation",false},
    {"simGetNameSuffix",_simGetNameSuffix,                      "Please use the newer 'sim.getNameSuffix' notation",false},
    {"simSetNameSuffix",_simSetNameSuffix,                      "Please use the newer 'sim.setNameSuffix' notation",false},
    {"simGetObjectHandle",_simGetObjectHandle,                  "Please use the newer 'sim.getObjectHandle' notation",false},
    {"simAddScript",_simAddScript,                              "Please use the newer 'sim.addScript' notation",false},
    {"simAssociateScriptWithObject",_simAssociateScriptWithObject,"Please use the newer 'sim.associateScriptWithObject' notation",false},
    {"simSetScriptText",_simSetScriptText,                      "Please use the newer 'sim.setScriptText' notation",false},
    {"simGetScriptHandle",_simGetScriptHandle,                  "Please use the newer 'sim.getScriptHandle' notation",false},
    {"simGetCollectionHandle",_simGetCollectionHandle,          "Please use the newer 'sim.getCollectionHandle' notation",false},
    {"simRemoveCollection",_simRemoveCollection,                "Please use the newer 'sim.removeCollection' notation",false},
    {"simEmptyCollection",_simEmptyCollection,                  "Please use the newer 'sim.emptyCollection' notation",false},
    {"simGetObjectPosition",_simGetObjectPosition,              "Please use the newer 'sim.getObjectPosition' notation",false},
    {"simGetObjectOrientation",_simGetObjectOrientation,        "Please use the newer 'sim.getObjectOrientation' notation",false},
    {"simSetObjectPosition",_simSetObjectPosition,              "Please use the newer 'sim.setObjectPosition' notation",false},
    {"simSetObjectOrientation",_simSetObjectOrientation,        "Please use the newer 'sim.setObjectOrientation' notation",false},
    {"simGetJointPosition",_simGetJointPosition,                "Please use the newer 'sim.getJointPosition' notation",false},
    {"simSetJointPosition",_simSetJointPosition,                "Please use the newer 'sim.setJointPosition' notation",false},
    {"simSetJointTargetPosition",_simSetJointTargetPosition,    "Please use the newer 'sim.setJointTargetPosition' notation",false},
    {"simGetJointTargetPosition",_simGetJointTargetPosition,    "Please use the newer 'sim.getJointTargetPosition' notation",false},
    {"simSetJointForce",_simSetJointForce,                      "Please use the newer 'sim.setJointForce' notation",false},
    {"simGetPathPosition",_simGetPathPosition,                  "Please use the newer 'sim.getPathPosition' notation",false},
    {"simSetPathPosition",_simSetPathPosition,                  "Please use the newer 'sim.setPathPosition' notation",false},
    {"simGetPathLength",_simGetPathLength,                      "Please use the newer 'sim.getPathLength' notation",false},
    {"simSetJointTargetVelocity",_simSetJointTargetVelocity,    "Please use the newer 'sim.setJointTargetVelocity' notation",false},
    {"simGetJointTargetVelocity",_simGetJointTargetVelocity,    "Please use the newer 'sim.getJointTargetVelocity' notation",false},
    {"simSetPathTargetNominalVelocity",_simSetPathTargetNominalVelocity,"Please use the newer 'sim.setPathTargetNominalVelocity' notation",false},
    {"simGetObjectName",_simGetObjectName,                      "Please use the newer 'sim.getObjectName' notation",false},
    {"simGetCollectionName",_simGetCollectionName,              "Please use the newer 'sim.getCollectionName' notation",false},
    {"simRemoveObject",_simRemoveObject,                        "Please use the newer 'sim.removeObject' notation",false},
    {"simRemoveModel",_simRemoveModel,                          "Please use the newer 'sim.removeModel' notation",false},
    {"simGetSimulationTime",_simGetSimulationTime,              "Please use the newer 'sim.getSimulationTime' notation",false},
    {"simGetSimulationState",_simGetSimulationState,            "Please use the newer 'sim.getSimulationState' notation",false},
    {"simGetSystemTime",_simGetSystemTime,                      "Please use the newer 'sim.getSystemTime' notation",false},
    {"simGetSystemTimeInMs",_simGetSystemTimeInMs,              "Please use the newer 'sim.getSystemTimeInMs' notation",false},
    {"simCheckCollision",_simCheckCollision,                    "Please use the newer 'sim.checkCollision' notation",false},
    {"simCheckCollisionEx",_simCheckCollisionEx,                "Please use the newer 'sim.checkCollisionEx' notation",false},
    {"simCheckDistance",_simCheckDistance,                      "Please use the newer 'sim.checkDistance' notation",false},
    {"simGetObjectConfiguration",_simGetObjectConfiguration,    "Please use the newer 'sim.getObjectConfiguration' notation",false},
    {"simSetObjectConfiguration",_simSetObjectConfiguration,    "Please use the newer 'sim.setObjectConfiguration' notation",false},
    {"simGetConfigurationTree",_simGetConfigurationTree,        "Please use the newer 'sim.getConfigurationTree' notation",false},
    {"simSetConfigurationTree",_simSetConfigurationTree,        "Please use the newer 'sim.setConfigurationTree' notation",false},
    {"simHandleMechanism",_simHandleMechanism,                  "Please use the newer 'sim.handleMechanism' notation",false},
    {"simGetSimulationTimeStep",_simGetSimulationTimeStep,      "Please use the newer 'sim.getSimulationTimeStep' notation",false},
    {"simGetSimulatorMessage",_simGetSimulatorMessage,          "Please use the newer 'sim.getSimulatorMessage' notation",false},
    {"simResetGraph",_simResetGraph,                            "Please use the newer 'sim.resetGraph' notation",false},
    {"simHandleGraph",_simHandleGraph,                          "Please use the newer 'sim.handleGraph' notation",false},
    {"simAddStatusbarMessage",_simAddStatusbarMessage,          "Please use the newer 'sim.addStatusbarMessage' notation",false},
    {"simGetLastError",_simGetLastError,                        "Please use the newer 'sim.getLastError' notation",false},
    {"simGetObjects",_simGetObjects,                            "Please use the newer 'sim.getObjects' notation",false},
    {"simRefreshDialogs",_simRefreshDialogs,                    "Please use the newer 'sim.refreshDialogs' notation",false},
    {"simGetModuleName",_simGetModuleName,                      "Please use the newer 'sim.getModuleName' notation",false},
    {"simGetIkGroupHandle",_simGetIkGroupHandle,                "Please use the newer 'sim.getIkGroupHandle' notation",false},
    {"simRemoveScript",_simRemoveScript,                        "Please use the newer 'sim.removeScript' notation",false},
    {"simGetCollisionHandle",_simGetCollisionHandle,            "Please use the newer 'sim.getCollisionHandle' notation",false},
    {"simGetDistanceHandle",_simGetDistanceHandle,              "Please use the newer 'sim.getDistanceHandle' notation",false},
    ...
    {"simGetObjectMatrix",_simGetObjectMatrix,                  "Please use the newer 'sim.getObjectMatrix' notation",false},
    {"simSetObjectMatrix",_simSetObjectMatrix,                  "Please use the newer 'sim.setObjectMatrix' notation",false},
    {"simGetJointMatrix",_simGetJointMatrix,                    "Please use the newer 'sim.getJointMatrix' notation",false},
    {"simSetSphericalJointMatrix",_simSetSphericalJointMatrix,  "Please use the newer 'sim.setSphericalJointMatrix' notation",false},
    {"simBuildIdentityMatrix",_simBuildIdentityMatrix,          "Please use the newer 'sim.buildIdentityMatrix' notation",false},
    {"simCopyMatrix",_simCopyMatrix,                            "Please use the newer 'sim.copyMatrix' notation",false},
    {"simBuildMatrix",_simBuildMatrix,                          "Please use the newer 'sim.buildMatrix' notation",false},
    {"simGetEulerAnglesFromMatrix",_simGetEulerAnglesFromMatrix,"Please use the newer 'sim.getEulerAnglesFromMatrix' notation",false},
    {"simInvertMatrix",_simInvertMatrix,                        "Please use the newer 'sim.invertMatrix' notation",false},
    {"simMultiplyMatrices",_simMultiplyMatrices,                "Please use the newer 'sim.multiplyMatrices' notation",false},
    {"simInterpolateMatrices",_simInterpolateMatrices,          "Please use the newer 'sim.interpolateMatrices' notation",false},
    {"simMultiplyVector",_simMultiplyVector,                    "Please use the newer 'sim.multiplyVector' notation",false},
    {"simGetObjectChild",_simGetObjectChild,                    "Please use the newer 'sim.getObjectChild' notation",false},
    {"simGetObjectParent",_simGetObjectParent,                  "Please use the newer 'sim.getObjectParent' notation",false},
    {"simSetObjectParent",_simSetObjectParent,                  "Please use the newer 'sim.setObjectParent' notation",false},
    {"simGetObjectType",_simGetObjectType,                      "Please use the newer 'sim.getObjectType' notation",false},
    {"simGetJointType",_simGetJointType,                        "Please use the newer 'sim.getJointType' notation",false},
    {"simSetBoolParameter",_simSetBoolParameter,                "Please use the newer 'sim.setBoolParameter' notation",false},
    {"simGetBoolParameter",_simGetBoolParameter,                "Please use the newer 'sim.getBoolParameter' notation",false},
    {"simSetInt32Parameter",_simSetInt32Parameter,              "Please use the newer 'sim.setInt32Parameter' notation",false},
    {"simGetInt32Parameter",_simGetInt32Parameter,              "Please use the newer 'sim.getInt32Parameter' notation",false},
    {"simSetFloatParameter",_simSetFloatParameter,              "Please use the newer 'sim.setFloatParameter' notation",false},
    {"simGetFloatParameter",_simGetFloatParameter,              "Please use the newer 'sim.getFloatParameter' notation",false},
    {"simSetStringParameter",_simSetStringParameter,            "Please use the newer 'sim.setStringParameter' notation",false},
    {"simGetStringParameter",_simGetStringParameter,            "Please use the newer 'sim.getStringParameter' notation",false},
    {"simSetArrayParameter",_simSetArrayParameter,              "Please use the newer 'sim.setArrayParameter' notation",false},
    {"simGetArrayParameter",_simGetArrayParameter,              "Please use the newer 'sim.getArrayParameter' notation",false},
    {"simSetObjectName",_simSetObjectName,                      "Please use the newer 'sim.setObjectName' notation",false},
    {"simSetCollectionName",_simSetCollectionName,              "Please use the newer 'sim.setCollectionName' notation",false},
    {"simGetJointInterval",_simGetJointInterval,                "Please use the newer 'sim.getJointInterval' notation",false},
    {"simSetJointInterval",_simSetJointInterval,                "Please use the newer 'sim.setJointInterval' notation",false},
    {"simLoadScene",_simLoadScene,                              "Please use the newer 'sim.loadScene' notation",false},
    {"simSaveScene",_simSaveScene,                              "Please use the newer 'sim.saveScene' notation",false},
    {"simLoadModel",_simLoadModel,                              "Please use the newer 'sim.loadModel' notation",false},
    {"simSaveModel",_simSaveModel,                              "Please use the newer 'sim.saveModel' notation",false},
    {"simIsObjectInSelection",_simIsObjectInSelection,          "Please use the newer 'sim.isObjectInSelection' notation",false},
    {"simAddObjectToSelection",_simAddObjectToSelection,        "Please use the newer 'sim.addObjectToSelection' notation",false},
    {"simRemoveObjectFromSelection",_simRemoveObjectFromSelection,"Please use the newer 'sim.removeObjectFromSelection' notation",false},
    {"simGetObjectSelection",_simGetObjectSelection,            "Please use the newer 'sim.getObjectSelection' notation",false},
    {"simGetRealTimeSimulation",_simGetRealTimeSimulation,      "Please use the newer 'sim.getRealTimeSimulation' notation",false},
    {"simSetNavigationMode",_simSetNavigationMode,              "Please use the newer 'sim.setNavigationMode' notation",false},
    {"simGetNavigationMode",_simGetNavigationMode,              "Please use the newer 'sim.getNavigationMode' notation",false},
    {"simSetPage",_simSetPage,                                  "Please use the newer 'sim.setPage' notation",false},
    {"simGetPage",_simGetPage,                                  "Please use the newer 'sim.getPage' notation",false},
    {"simCopyPasteObjects",_simCopyPasteObjects,                "Please use the newer 'sim.copyPasteObjects' notation",false},
    {"simScaleObjects",_simScaleObjects,                        "Please use the newer 'sim.scaleObjects' notation",false},
    {"simGetObjectUniqueIdentifier",_simGetObjectUniqueIdentifier,"Please use the newer 'sim.getObjectUniqueIdentifier' notation",false},
    {"simSetThreadAutomaticSwitch",_simSetThreadAutomaticSwitch,"Please use the newer 'sim.setThreadAutomaticSwitch' notation",false},
    {"simGetThreadAutomaticSwitch",_simGetThreadAutomaticSwitch,"Please use the newer 'sim.getThreadAutomaticSwitch' notation",false},
    {"simSetThreadSwitchTiming",_simSetThreadSwitchTiming,      "Please use the newer 'sim.setThreadSwitchTiming' notation",false},
    {"simSetThreadResumeLocation",_simSetThreadResumeLocation,  "Please use the newer 'sim.setThreadResumeLocation' notation",false},
    {"simResumeThreads",_simResumeThreads,                      "Please use the newer 'sim.resumeThreads' notation",false},
    {"simSwitchThread",_simSwitchThread,                        "Please use the newer 'sim.switchThread' notation",false},
    {"simCreateIkGroup",_simCreateIkGroup,                      "Please use the newer 'sim.createIkGroup' notation",false},
    {"simRemoveIkGroup",_simRemoveIkGroup,                      "Please use the newer 'sim.removeIkGroup' notation",false},
    {"simCreateIkElement",_simCreateIkElement,                  "Please use the newer 'sim.createIkElement' notation",false},
    {"simCreateCollection",_simCreateCollection,                "Please use the newer 'sim.createCollection' notation",false},
    {"simAddObjectToCollection",_simAddObjectToCollection,      "Please use the newer 'sim.addObjectToCollection' notation",false},
    {"simSaveImage",_simSaveImage,                              "Please use the newer 'sim.saveImage' notation",false},
    {"simLoadImage",_simLoadImage,                              "Please use the newer 'sim.loadImage' notation",false},
    {"simGetScaledImage",_simGetScaledImage,                    "Please use the newer 'sim.getScaledImage' notation",false},
    {"simTransformImage",_simTransformImage,                    "Please use the newer 'sim.transformImage' notation",false},
    {"simGetQHull",_simGetQHull,                                "Please use the newer 'sim.getQHull' notation",false},
    {"simGetDecimatedMesh",_simGetDecimatedMesh,                "Please use the newer 'sim.getDecimatedMesh' notation",false},
    {"simExportIk",_simExportIk,                                "Please use the newer 'sim.exportIk' notation",false},
    {"simComputeJacobian",_simComputeJacobian,                  "Please use the newer 'sim.computeJacobian' notation",false},
    {"simSendData",_simSendData,                                "Please use the newer 'sim.sendData' notation",false},
    {"simReceiveData",_simReceiveData,                          "Please use the newer 'sim.receiveData' notation",false},
    {"simPackInt32Table",_simPackInt32Table,                    "Please use the newer 'sim.packInt32Table' notation",false},
    {"simPackUInt32Table",_simPackUInt32Table,                  "Please use the newer 'sim.packUInt32Table' notation",false},
    {"simPackFloatTable",_simPackFloatTable,                    "Please use the newer 'sim.packFloatTable' notation",false},
    {"simPackDoubleTable",_simPackDoubleTable,                  "Please use the newer 'sim.packDoubleTable' notation",false},
    {"simPackUInt8Table",_simPackUInt8Table,                    "Please use the newer 'sim.packUInt8Table' notation",false},
    {"simPackUInt16Table",_simPackUInt16Table,                  "Please use the newer 'sim.packUInt16Table' notation",false},
    {"simUnpackInt32Table",_simUnpackInt32Table,                "Please use the newer 'sim.unpackInt32Table' notation",false},
    {"simUnpackUInt32Table",_simUnpackUInt32Table,              "Please use the newer 'sim.unpackUInt32Table' notation",false},
    {"simUnpackFloatTable",_simUnpackFloatTable,                "Please use the newer 'sim.unpackFloatTable' notation",false},
    {"simUnpackDoubleTable",_simUnpackDoubleTable,              "Please use the newer 'sim.unpackDoubleTable' notation",false},
    {"simUnpackUInt8Table",_simUnpackUInt8Table,                "Please use the newer 'sim.unpackUInt8Table' notation",false},
    {"simUnpackUInt16Table",_simUnpackUInt16Table,              "Please use the newer 'sim.unpackUInt16Table' notation",false},
    {"simPackTable",_simPackTable,                              "Please use the newer 'sim.packTable' notation",false},
    {"simUnpackTable",_simUnpackTable,                          "Please use the newer 'sim.unpackTable' notation",false},
    {"simTransformBuffer",_simTransformBuffer,                  "Please use the newer 'sim.transformBuffer' notation",false},
    {"simCombineRgbImages",_simCombineRgbImages,                "Please use the newer 'sim.combineRgbImages' notation",false},
    {"simGetVelocity",_simGetVelocity,                          "Please use the newer 'sim.getVelocity' notation",false},
    {"simGetObjectVelocity",_simGetObjectVelocity,              "Please use the newer 'sim.getObjectVelocity' notation",false},
    {"simAddForceAndTorque",_simAddForceAndTorque,              "Please use the newer 'sim.addForceAndTorque' notation",false},
    {"simAddForce",_simAddForce,                                "Please use the newer 'sim.addForce' notation",false},
    {"simSetExplicitHandling",_simSetExplicitHandling,          "Please use the newer 'sim.setExplicitHandling' notation",false},
    {"simGetExplicitHandling",_simGetExplicitHandling,          "Please use the newer 'sim.getExplicitHandling' notation",false},
    {"simSetGraphUserData",_simSetGraphUserData,                "Please use the newer 'sim.setGraphUserData' notation",false},
    {"simAddDrawingObject",_simAddDrawingObject,                "Please use the newer 'sim.addDrawingObject' notation",false},
    {"simRemoveDrawingObject",_simRemoveDrawingObject,          "Please use the newer 'sim.removeDrawingObject' notation",false},
    {"simAddDrawingObjectItem",_simAddDrawingObjectItem,        "Please use the newer 'sim.addDrawingObjectItem' notation",false},
    {"simAddParticleObject",_simAddParticleObject,              "Please use the newer 'sim.addParticleObject' notation",false},
    {"simRemoveParticleObject",_simRemoveParticleObject,        "Please use the newer 'sim.removeParticleObject' notation",false},
    {"simAddParticleObjectItem",_simAddParticleObjectItem,      "Please use the newer 'sim.addParticleObjectItem' notation",false},
    {"simGetObjectSizeFactor",_simGetObjectSizeFactor,          "Please use the newer 'sim.getObjectSizeFactor' notation",false},
    {"simResetMilling",_simResetMilling,                        "Please use the newer 'sim.resetMilling' notation",false},
    {"simApplyMilling",_simApplyMilling,                        "Please use the newer 'sim.applyMilling' notation",false},
    {"simSetIntegerSignal",_simSetIntegerSignal,                "Please use the newer 'sim.setIntegerSignal' notation",false},
    {"simGetIntegerSignal",_simGetIntegerSignal,                "Please use the newer 'sim.getIntegerSignal' notation",false},
    {"simClearIntegerSignal",_simClearIntegerSignal,            "Please use the newer 'sim.clearIntegerSignal' notation",false},
    {"simSetFloatSignal",_simSetFloatSignal,                    "Please use the newer 'sim.setFloatSignal' notation",false},
    {"simGetFloatSignal",_simGetFloatSignal,                    "Please use the newer 'sim.getFloatSignal' notation",false},
    {"simClearFloatSignal",_simClearFloatSignal,                "Please use the newer 'sim.clearFloatSignal' notation",false},
    {"simSetStringSignal",_simSetStringSignal,                  "Please use the newer 'sim.setStringSignal' notation",false},
    {"simGetStringSignal",_simGetStringSignal,                  "Please use the newer 'sim.getStringSignal' notation",false},
    {"simClearStringSignal",_simClearStringSignal,              "Please use the newer 'sim.clearStringSignal' notation",false},
    {"simGetSignalName",_simGetSignalName,                      "Please use the newer 'sim.getSignalName' notation",false},
    {"simWaitForSignal",_simWaitForSignal,                      "Please use the newer 'sim.waitForSignal' notation",false},
    {"simPersistentDataWrite",_simPersistentDataWrite,          "Please use the newer 'sim.persistentDataWrite' notation",false},
    {"simPersistentDataRead",_simPersistentDataRead,            "Please use the newer 'sim.persistentDataRead' notation",false},
    {"simSetObjectProperty",_simSetObjectProperty,              "Please use the newer 'sim.setObjectProperty' notation",false},
    {"simGetObjectProperty",_simGetObjectProperty,              "Please use the newer 'sim.getObjectProperty' notation",false},
    {"simSetObjectSpecialProperty",_simSetObjectSpecialProperty,"Please use the newer 'sim.setObjectSpecialProperty' notation",false},
    {"simGetObjectSpecialProperty",_simGetObjectSpecialProperty,"Please use the newer 'sim.getObjectSpecialProperty' notation",false},
    {"simSetModelProperty",_simSetModelProperty,                "Please use the newer 'sim.setModelProperty' notation",false},
    {"simGetModelProperty",_simGetModelProperty,                "Please use the newer 'sim.getModelProperty' notation",false},
    {"simMoveToPosition",_simMoveToPosition,                    "Please use the newer 'sim.moveToPosition' notation",false},
    {"simMoveToObject",_simMoveToObject,                        "Please use the newer 'sim.moveToObject' notation",false},
    {"simFollowPath",_simFollowPath,                            "Please use the newer 'sim.followPath' notation",false},
    {"simMoveToJointPositions",_simMoveToJointPositions,        "Please use the newer 'sim.moveToJointPositions' notation",false},
    {"simWait",_simWait,                                        "Please use the newer 'sim.wait' notation",false},
    {"simGetDataOnPath",_simGetDataOnPath,                      "Please use the newer 'sim.getDataOnPath' notation",false},
    {"simGetPositionOnPath",_simGetPositionOnPath,              "Please use the newer 'sim.getPositionOnPath' notation",false},
    {"simGetOrientationOnPath",_simGetOrientationOnPath,        "Please use the newer 'sim.getOrientationOnPath' notation",false},
    {"simGetClosestPositionOnPath",_simGetClosestPositionOnPath,"Please use the newer 'sim.getClosestPositionOnPath' notation",false},
    {"simReadForceSensor",_simReadForceSensor,                  "Please use the newer 'sim.readForceSensor' notation",false},
    {"simBreakForceSensor",_simBreakForceSensor,                "Please use the newer 'sim.breakForceSensor' notation",false},
    {"simGetLightParameters",_simGetLightParameters,            "Please use the newer 'sim.getLightParameters' notation",false},
    {"simSetLightParameters",_simSetLightParameters,            "Please use the newer 'sim.setLightParameters' notation",false},
    {"simGetLinkDummy",_simGetLinkDummy,                        "Please use the newer 'sim.getLinkDummy' notation",false},
    {"simSetLinkDummy",_simSetLinkDummy,                        "Please use the newer 'sim.setLinkDummy' notation",false},
    {"simSetShapeColor",_simSetShapeColor,                      "Please use the newer 'sim.setShapeColor' notation",false},
    {"simGetShapeColor",_simGetShapeColor,                      "Please use the newer 'sim.getShapeColor' notation",false},
    {"simResetDynamicObject",_simResetDynamicObject,            "Please use the newer 'sim.resetDynamicObject' notation",false},
    {"simSetJointMode",_simSetJointMode,                        "Please use the newer 'sim.setJointMode' notation",false},
    {"simGetJointMode",_simGetJointMode,                        "Please use the newer 'sim.getJointMode' notation",false},
    {"simSerialOpen",_simSerialOpen,                            "Please use the newer 'sim.serialOpen' notation",false},
    {"simSerialClose",_simSerialClose,                          "Please use the newer 'sim.serialClose' notation",false},
    {"simSerialSend",_simSerialSend,                            "Please use the newer 'sim.serialSend' notation",false},
    {"simSerialRead",_simSerialRead,                            "Please use the newer 'sim.serialRead' notation",false},
    {"simSerialCheck",_simSerialCheck,                          "Please use the newer 'sim.serialCheck' notation",false},
    {"simGetContactInfo",_simGetContactInfo,                    "Please use the newer 'sim.getContactInfo' notation",false},
    {"simSetThreadIsFree",_simSetThreadIsFree,                  "Please use the newer 'sim.setThreadIsFree' notation",false},
    {"simTubeOpen",_simTubeOpen,                                "Please use the newer 'sim.tubeOpen' notation",false},
    {"simTubeClose",_simTubeClose,                              "Please use the newer 'sim.tubeClose' notation",false},
    {"simTubeWrite",_simTubeWrite,                              "Please use the newer 'sim.tubeWrite' notation",false},
    {"simTubeRead",_simTubeRead,                                "Please use the newer 'sim.tubeRead' notation",false},
    {"simTubeStatus",_simTubeStatus,                            "Please use the newer 'sim.tubeStatus' notation",false},
    {"simAuxiliaryConsoleOpen",_simAuxiliaryConsoleOpen,        "Please use the newer 'sim.auxiliaryConsoleOpen' notation",false},
    {"simAuxiliaryConsoleClose",_simAuxiliaryConsoleClose,      "Please use the newer 'sim.auxiliaryConsoleClose' notation",false},
    {"simAuxiliaryConsolePrint",_simAuxiliaryConsolePrint,      "Please use the newer 'sim.auxiliaryConsolePrint' notation",false},
    {"simAuxiliaryConsoleShow",_simAuxiliaryConsoleShow,        "Please use the newer 'sim.auxiliaryConsoleShow' notation",false},
    {"simImportShape",_simImportShape,                          "Please use the newer 'sim.importShape' notation",false},
    {"simImportMesh",_simImportMesh,                            "Please use the newer 'sim.importMesh' notation",false},
    {"simExportMesh",_simExportMesh,                            "Please use the newer 'sim.exportMesh' notation",false},
    {"simCreateMeshShape",_simCreateMeshShape,                  "Please use the newer 'sim.createMeshShape' notation",false},
    {"simGetShapeMesh",_simGetShapeMesh,                        "Please use the newer 'sim.getShapeMesh' notation",false},
    {"simCreatePureShape",_simCreatePureShape,                  "Please use the newer 'sim.createPureShape' notation",false},
    {"simCreateHeightfieldShape",_simCreateHeightfieldShape,    "Please use the newer 'sim.createHeightfieldShape' notation",false},
    {"simAddBanner",_simAddBanner,                              "Please use the newer 'sim.addBanner' notation",false},
    {"simRemoveBanner",_simRemoveBanner,                        "Please use the newer 'sim.removeBanner' notation",false},
    {"simCreateJoint",_simCreateJoint,                          "Please use the newer 'sim.createJoint' notation",false},
    {"simCreateDummy",_simCreateDummy,                          "Please use the newer 'sim.createDummy' notation",false},
    {"simCreateProximitySensor",_simCreateProximitySensor,      "Please use the newer 'sim.createProximitySensor' notation",false},
    {"simCreatePath",_simCreatePath,                            "Please use the newer 'sim.createPath' notation",false},
    {"simCreateForceSensor",_simCreateForceSensor,              "Please use the newer 'sim.createForceSensor' notation",false},
    {"simCreateVisionSensor",_simCreateVisionSensor,            "Please use the newer 'sim.createVisionSensor' notation",false},
    {"simInsertPathCtrlPoints",_simInsertPathCtrlPoints,        "Please use the newer 'sim.insertPathCtrlPoints' notation",false},
    {"simCutPathCtrlPoints",_simCutPathCtrlPoints,              "Please use the newer 'sim.cutPathCtrlPoints' notation",false},
    {"simGetIkGroupMatrix",_simGetIkGroupMatrix,                "Please use the newer 'sim.getIkGroupMatrix' notation",false},
    {"simFloatingViewAdd",_simFloatingViewAdd,                  "Please use the newer 'sim.floatingViewAdd' notation",false},
    {"simFloatingViewRemove",_simFloatingViewRemove,            "Please use the newer 'sim.floatingViewRemove' notation",false},
    {"simAdjustView",_simAdjustView,                            "Please use the newer 'sim.adjustView' notation",false},
    {"simCameraFitToView",_simCameraFitToView,                  "Please use the newer 'sim.cameraFitToView' notation",false},
    {"simAnnounceSceneContentChange",_simAnnounceSceneContentChange,"Please use the newer 'sim.announceSceneContentChange' notation",false},
    {"simGetObjectInt32Parameter",_simGetObjectInt32Parameter,  "Please use the newer 'sim.getObjectInt32Parameter' notation",false},
    {"simSetObjectInt32Parameter",_simSetObjectInt32Parameter,  "Please use the newer 'sim.setObjectInt32Parameter' notation",false},
    {"simGetObjectFloatParameter",_simGetObjectFloatParameter,  "Please use the newer 'sim.getObjectFloatParameter' notation",false},
    {"simSetObjectFloatParameter",_simSetObjectFloatParameter,  "Please use the newer 'sim.setObjectFloatParameter' notation",false},
    {"simGetObjectStringParameter",_simGetObjectStringParameter,"Please use the newer 'sim.getObjectStringParameter' notation",false},
    {"simSetObjectStringParameter",_simSetObjectStringParameter,"Please use the newer 'sim.setObjectStringParameter' notation",false},
    {"simGetRotationAxis",_simGetRotationAxis,                  "Please use the newer 'sim.getRotationAxis' notation",false},
    {"simRotateAroundAxis",_simRotateAroundAxis,                "Please use the newer 'sim.rotateAroundAxis' notation",false},
    {"simLaunchExecutable",_simLaunchExecutable,                "Please use the newer 'sim.launchExecutable' notation",false},
    {"simGetJointForce",_simGetJointForce,                      "Please use the newer 'sim.getJointForce' notation",false},
    {"simSetIkGroupProperties",_simSetIkGroupProperties,        "Please use the newer 'sim.setIkGroupProperties' notation",false},
    {"simSetIkElementProperties",_simSetIkElementProperties,    "Please use the newer 'sim.setIkElementProperties' notation",false},
    {"simIsHandleValid",_simIsHandleValid,                      "Please use the newer 'sim.isHandleValid' notation",false},
    {"simGetObjectQuaternion",_simGetObjectQuaternion,          "Please use the newer 'sim.getObjectQuaternion' notation",false},
    {"simSetObjectQuaternion",_simSetObjectQuaternion,          "Please use the newer 'sim.setObjectQuaternion' notation",false},
    {"simSetShapeMassAndInertia",_simSetShapeMassAndInertia,    "Please use the newer 'sim.setShapeMassAndInertia' notation",false},
    {"simGetShapeMassAndInertia",_simGetShapeMassAndInertia,    "Please use the newer 'sim.getShapeMassAndInertia' notation",false},
    {"simGroupShapes",_simGroupShapes,                          "Please use the newer 'sim.groupShapes' notation",false},
    {"simUngroupShape",_simUngroupShape,                        "Please use the newer 'sim.ungroupShape' notation",false},
    {"simConvexDecompose",_simConvexDecompose,                  "Please use the newer 'sim.convexDecompose' notation",false},
    {"simAddGhost",_simAddGhost,                                "Please use the newer 'sim.addGhost' notation",false},
    {"simModifyGhost",_simModifyGhost,                          "Please use the newer 'sim.modifyGhost' notation",false},
    {"simQuitSimulator",_simQuitSimulator,                      "Please use the newer 'sim.quitSimulator' notation",false},
    {"simGetThreadId",_simGetThreadId,                          "Please use the newer 'sim.getThreadId' notation",false},
    {"simSetShapeMaterial",_simSetShapeMaterial,                "Please use the newer 'sim.setShapeMaterial' notation",false},
    {"simGetTextureId",_simGetTextureId,                        "Please use the newer 'sim.getTextureId' notation",false},
    {"simReadTexture",_simReadTexture,                          "Please use the newer 'sim.readTexture' notation",false},
    {"simWriteTexture",_simWriteTexture,                        "Please use the newer 'sim.writeTexture' notation",false},
    {"simCreateTexture",_simCreateTexture,                      "Please use the newer 'sim.createTexture' notation",false},
    {"simWriteCustomDataBlock",_simWriteCustomDataBlock,        "Please use the newer 'sim.writeCustomDataBlock' notation",false},
    {"simReadCustomDataBlock",_simReadCustomDataBlock,          "Please use the newer 'sim.readCustomDataBlock' notation",false},
    {"simReadCustomDataBlockTags",_simReadCustomDataBlockTags,  "Please use the newer 'sim.readCustomDataBlockTags' notation",false},
    {"simAddPointCloud",_simAddPointCloud,                      "Please use the newer 'sim.addPointCloud' notation",false},
    {"simModifyPointCloud",_simModifyPointCloud,                "Please use the newer 'sim.modifyPointCloud' notation",false},
    {"simGetShapeGeomInfo",_simGetShapeGeomInfo,                "Please use the newer 'sim.getShapeGeomInfo' notation",false},
    {"simGetObjectsInTree",_simGetObjectsInTree,                "Please use the newer 'sim.getObjectsInTree' notation",false},
    {"simSetObjectSizeValues",_simSetObjectSizeValues,          "Please use the newer 'sim.setObjectSizeValues' notation",false},
    {"simGetObjectSizeValues",_simGetObjectSizeValues,          "Please use the newer 'sim.getObjectSizeValues' notation",false},
    {"simScaleObject",_simScaleObject,                          "Please use the newer 'sim.scaleObject' notation",false},
    {"simSetShapeTexture",_simSetShapeTexture,                  "Please use the newer 'sim.setShapeTexture' notation",false},
    {"simGetShapeTextureId",_simGetShapeTextureId,              "Please use the newer 'sim.getShapeTextureId' notation",false},
    {"simGetCollectionObjects",_simGetCollectionObjects,        "Please use the newer 'sim.getCollectionObjects' notation",false},
    {"simHandleCustomizationScripts",_simHandleCustomizationScripts,"Please use the newer 'sim.handleCustomizationScripts' notation",false},
    {"simSetScriptAttribute",_simSetScriptAttribute,            "Please use the newer 'sim.setScriptAttribute' notation",false},
    {"simGetScriptAttribute",_simGetScriptAttribute,            "Please use the newer 'sim.getScriptAttribute' notation",false},
    {"simHandleChildScripts",_simHandleChildScripts,            "Please use the newer 'sim.handleChildScripts' notation",false},
    {"simLaunchThreadedChildScripts",_simLaunchThreadedChildScripts,"Please use the newer 'sim.launchThreadedChildScripts' notation",false},
    {"simReorientShapeBoundingBox",_simReorientShapeBoundingBox,"Please use the newer 'sim.reorientShapeBoundingBox' notation",false},
    {"simHandleVisionSensor",_simHandleVisionSensor,            "Please use the newer 'sim.handleVisionSensor' notation",false},
    {"simReadVisionSensor",_simReadVisionSensor,                "Please use the newer 'sim.readVisionSensor' notation",false},
    {"simResetVisionSensor",_simResetVisionSensor,              "Please use the newer 'sim.resetVisionSensor' notation",false},
    {"simGetVisionSensorResolution",_simGetVisionSensorResolution,"Please use the newer 'sim.getVisionSensorResolution' notation",false},
    {"simGetVisionSensorImage",_simGetVisionSensorImage,        "Please use the newer 'sim.getVisionSensorImage' notation",false},
    {"simSetVisionSensorImage",_simSetVisionSensorImage,        "Please use the newer 'sim.setVisionSensorImage' notation",false},
    {"simGetVisionSensorCharImage",_simGetVisionSensorCharImage,"Please use the newer 'sim.getVisionSensorCharImage' notation",false},
    {"simSetVisionSensorCharImage",_simSetVisionSensorCharImage,"Please use the newer 'sim.setVisionSensorCharImage' notation",false},
    {"simGetVisionSensorDepthBuffer",_simGetVisionSensorDepthBuffer,"Please use the newer 'sim.getVisionSensorDepthBuffer' notation",false},
    {"simCheckVisionSensor",_simCheckVisionSensor,              "Please use the newer 'sim.checkVisionSensor' notation",false},
    {"simCheckVisionSensorEx",_simCheckVisionSensorEx,          "Please use the newer 'sim.checkVisionSensorEx' notation",false},
    {"simRMLPos",_simRMLPos,                                    "Please use the newer 'sim.rmlPos' notation",false},
    {"simRMLVel",_simRMLVel,                                    "Please use the newer 'sim.rmlVel' notation",false},
    {"simRMLStep",_simRMLStep,                                  "Please use the newer 'sim.rmlStep' notation",false},
    {"simRMLRemove",_simRMLRemove,                              "Please use the newer 'sim.rmlRemove' notation",false},
    {"simRMLMoveToPosition",_simRMLMoveToPosition,              "Please use the newer 'sim.rmlMoveToPosition' notation",false},
    {"simRMLMoveToJointPositions",_simRMLMoveToJointPositions,  "Please use the newer 'sim.rmlMoveToJointPositions' notation",false},
    {"simBuildMatrixQ",_simBuildMatrixQ,                        "Please use the newer 'sim.buildMatrixQ' notation",false},
    {"simGetQuaternionFromMatrix",_simGetQuaternionFromMatrix,  "Please use the newer 'sim.getQuaternionFromMatrix' notation",false},
    {"simFileDialog",_simFileDialog,                            "Please use the newer 'sim.fileDialog' notation",false},
    {"simMsgBox",_simMsgBox,                                    "Please use the newer 'sim.msgBox' notation",false},
    {"simLoadModule",_simLoadModule,                            "Please use the newer 'sim.loadModule' notation",false},
    {"simUnloadModule",_simUnloadModule,                        "Please use the newer 'sim.unloadModule' notation",false},
    {"simCallScriptFunction",_simCallScriptFunction,            "Please use the newer 'sim.callScriptFunction' notation",false},
    {"simGetConfigForTipPose",_simGetConfigForTipPose,          "Please use the newer 'sim.getConfigForTipPose' notation",false},
    {"simGenerateIkPath",_simGenerateIkPath,                    "Please use the newer 'sim.generateIkPath' notation",false},
    {"simGetExtensionString",_simGetExtensionString,            "Please use the newer 'sim.getExtensionString' notation",false},
    {"simComputeMassAndInertia",_simComputeMassAndInertia,      "Please use the newer 'sim.computeMassAndInertia' notation",false},
    {"simSetScriptVariable",_simSetScriptVariable,              "Please use the newer 'sim.setScriptVariable' notation",false},
    {"simGetEngineFloatParameter",_simGetEngineFloatParameter,  "Please use the newer 'sim.getEngineFloatParameter' notation",false},
    {"simGetEngineInt32Parameter",_simGetEngineInt32Parameter,  "Please use the newer 'sim.getEngineInt32Parameter' notation",false},
    {"simGetEngineBoolParameter",_simGetEngineBoolParameter,    "Please use the newer 'sim.getEngineBoolParameter' notation",false},
    {"simSetEngineFloatParameter",_simSetEngineFloatParameter,  "Please use the newer 'sim.setEngineFloatParameter' notation",false},
    {"simSetEngineInt32Parameter",_simSetEngineInt32Parameter,  "Please use the newer 'sim.setEngineInt32Parameter' notation",false},
    {"simSetEngineBoolParameter",_simSetEngineBoolParameter,    "Please use the newer 'sim.setEngineBoolParameter' notation",false},
    {"simCreateOctree",_simCreateOctree,                        "Please use the newer 'sim.createOctree' notation",false},
    {"simCreatePointCloud",_simCreatePointCloud,                "Please use the newer 'sim.createPointCloud' notation",false},
    {"simSetPointCloudOptions",_simSetPointCloudOptions,        "Please use the newer 'sim.setPointCloudOptions' notation",false},
    {"simGetPointCloudOptions",_simGetPointCloudOptions,        "Please use the newer 'sim.getPointCloudOptions' notation",false},
    {"simInsertVoxelsIntoOctree",_simInsertVoxelsIntoOctree,    "Please use the newer 'sim.insertVoxelsIntoOctree' notation",false},
    {"simRemoveVoxelsFromOctree",_simRemoveVoxelsFromOctree,    "Please use the newer 'sim.removeVoxelsFromOctree' notation",false},
    {"simInsertPointsIntoPointCloud",_simInsertPointsIntoPointCloud,"Please use the newer 'sim.insertPointsIntoPointCloud' notation",false},
    {"simRemovePointsFromPointCloud",_simRemovePointsFromPointCloud,"Please use the newer 'sim.removePointsFromPointCloud' notation",false},
    {"simIntersectPointsWithPointCloud",_simIntersectPointsWithPointCloud,"Please use the newer 'sim.intersectPointsWithPointCloud' notation",false},
    {"simGetOctreeVoxels",_simGetOctreeVoxels,                  "Please use the newer 'sim.getOctreeVoxels' notation",false},
    {"simGetPointCloudPoints",_simGetPointCloudPoints,          "Please use the newer 'sim.getPointCloudPoints' notation",false},
    {"simInsertObjectIntoOctree",_simInsertObjectIntoOctree,    "Please use the newer 'sim.insertObjectIntoOctree' notation",false},
    {"simSubtractObjectFromOctree",_simSubtractObjectFromOctree,    "Please use the newer 'sim.subtractObjectFromOctree' notation",false},
    {"simInsertObjectIntoPointCloud",_simInsertObjectIntoPointCloud,"Please use the newer 'sim.insertObjectIntoPointCloud' notation",false},
    {"simSubtractObjectFromPointCloud",_simSubtractObjectFromPointCloud,    "Please use the newer 'sim.subtractObjectFromPointCloud' notation",false},
    {"simCheckOctreePointOccupancy",_simCheckOctreePointOccupancy,"Please use the newer 'sim.checkOctreePointOccupancy' notation",false},
    {"simOpenTextEditor",_simOpenTextEditor,                    "Please use the newer 'sim.openTextEditor' notation",false},
    {"simSetVisionSensorFilter",_simSetVisionSensorFilter,      "Please use the newer 'sim.setVisionSensorFilter' notation",false},
    {"simGetVisionSensorFilter",_simGetVisionSensorFilter,      "Please use the newer 'sim.getVisionSensorFilter' notation",false},
    {"simHandleSimulationStart",_simHandleSimulationStart,      "Please use the newer 'sim.handleSimulationStart' notation",false},
    {"simHandleSensingStart",_simHandleSensingStart,            "Please use the newer 'sim.handleSensingStart' notation",false},
    {"simAuxFunc",_simAuxFunc,                                  "Please use the newer 'sim.auxFunc' notation",false},
    {"simSetReferencedHandles",_simSetReferencedHandles,        "Please use the newer 'sim.setReferencedHandles' notation",false},
    {"simGetReferencedHandles",_simGetReferencedHandles,        "Please use the newer 'sim.getReferencedHandles' notation",false},
    {"simGetGraphCurve",_simGetGraphCurve,                        "Please use the newer 'sim.getGraphCurve' notation",false},
    {"simTest",_simTest,                                        "Please use the newer 'sim.test' notation",false},
...
{ // Returns all scripts that are built under the current one
    ...
    if (it!=NULL)
    {
        ...
        { // we have a joint ctrl callback script
            C3DObject* obj=App::ct->objCont->getObject(it->getObjectIDThatScriptIsAttachedTo_callback_OLD());
            if (obj!=NULL)
            { // should always pass
                if (selfIncluded)
                {
...
int _genericFunctionHandler_new(luaWrap_lua_State* L,CLuaCustomFunction* func,std::string& raiseErrorWithMsg)
{
    ...
    {
        C3DObject* obj=App::ct->objCont->getObject(itObj->getObjectIDThatScriptIsAttachedTo_callback_OLD());
        if (obj!=NULL)
            linkedObject=obj->getID();
    }
...
int _simIsScriptExecutionThreaded(luaWrap_lua_State* L)
{
    ...
    CLuaScriptObject* it=App::ct->luaScriptContainer->getScriptFromID_noAddOnsNorSandbox(currentScriptID);
    int retVal=0;
    if ((it!=NULL)&&it->getThreadedExecution())
        retVal=1;
...
int _simRemoveObject(luaWrap_lua_State* L)
{
    ...
    if (checkInputArguments(L,&errorString,lua_arg_number,0))
    {
        ...
        { // this script runs threaded and wants to destroy another object (than itself probably). We need to make sure that it will only destroy objects that do not have any scripts attached with a non-NULL lua state:
...
int _simRemoveModel(luaWrap_lua_State* L)
{
    ...
    if (checkInputArguments(L,&errorString,lua_arg_number,0))
    {
        ...
        { // this script runs threaded and wants to destroy other objects. We need to make sure that it will only destroy objects that do not have any scripts attached with a non-NULL lua state:
            C3DObject* objBase=App::ct->objCont->getObject(objId);
            if (objBase!=NULL)
            {
    ...
    if (checkInputArguments(L,&errorString,lua_arg_number,0))
    {
        ...
        if (res>=0)
        {
            ...
            { // here we don't save to file, but to buffer:
                ...
                {
                    C3DObject* it=App::ct->objCont->getObject(model);
                    if (it!=NULL)
                    {
                        if (it->getModelBase())
                        {
...
int _simLoadImage(luaWrap_lua_State* L)
{
    ...
    if (checkInputArguments(L,&errorString,lua_arg_number,0,lua_arg_string,0))
    {
        ...
        if ( (dataLength>4)&&(data[0]=='@')&&(data[1]=='m')&&(data[2]=='e')&&(data[3]=='m') )
        {
            ...
            img=simLoadImage_internal(resol,options,data,NULL);
        if (img!=NULL)
        {
...
int _simExportMesh(luaWrap_lua_State* L)
{
    ...
    if (checkInputArguments(L,&errorString,lua_arg_number,0,lua_arg_string,0,lua_arg_number,0,lua_arg_number,0))
    {
        ...
        if ( (luaWrap_lua_gettop(L)>=8)&&luaWrap_lua_istable(L,5)&&luaWrap_lua_istable(L,6)&&luaWrap_lua_isnil(L,7)&&luaWrap_lua_istable(L,8) )
        {
            ...
            int nameE=(int)luaWrap_lua_objlen(L,8);
